...
export default function ServerPicker({ title, season, episode, active, suggestedEdition, disabled, onLoad }: Props) {
  ...
  const [selected, setSelected] = useState<ServerKey | null>(initial?.server ?? 'bingr');
