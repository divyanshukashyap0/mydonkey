    ...
    return (
        <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-black font-sans text-white">
            ...
            <div className="relative z-10 w-full max-w-md p-8 md:p-12 animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="mt-8 flex flex-col gap-4">
                    <button
                        ...
                        className="w-full text-sm font-bold text-gray-400 hover:text-white transition uppercase tracking-wider mb-2"
                    >
                        Continue as Guest
                    </button>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase"><span className="bg-transparent px-2 text-gray-400 backdrop-blur-sm">Or sign in</span></div>
                    </div>
            ...
            <div className="absolute bottom-6 text-xs text-gray-500">
                &copy; 2026 My Donkey Inc. All rights reserved.
            </div>
        </div>
    );
};
